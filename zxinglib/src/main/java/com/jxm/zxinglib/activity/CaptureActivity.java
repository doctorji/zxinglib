...
import com.jxm.zxinglib.camera.CameraManager;
import com.jxm.zxinglib.decode.DecodeThread;
import com.jxm.zxinglib.utils.BeepManager;
import com.jxm.zxinglib.utils.CaptureActivityHandler;
import com.jxm.zxinglib.utils.IdentifyQR;
import com.jxm.zxinglib.utils.InactivityTimer;
...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    public void doBusiness(final Context mContext) {
        ...
        bt = (ImageView) findViewById(R.id.bt_shan);
        xc = (ImageView) findViewById(R.id.bt_xiangce);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (shan == 0) {
                    ...
                    bt.setImageResource(R.drawable.checked);
                } else if (shan == 1) {
                    shan = 0;
                    cameraManager.setTorch(false);
                    bt.setImageResource(R.drawable.unchecked);
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SELECT_PIC && resultCode == Activity.RESULT_OK) { //4.4以下图库
            ...
            String path = IdentifyQR.getPath(context, uri);
            Result result = IdentifyQR.scanningImage(path);
            if (result == null) {
                Toast.makeText(context, "未发现二维码/条形码", Toast.LENGTH_LONG).show();
            } else {
                // 数据返回
                String recode = IdentifyQR.recode(result.toString());
